...
class AttractionService {
  ...
  static const String _endpoint = 'https://taipei-attractions-information.vercel.app/attractions/random/zh-tw';
  static const int _minAttractions = 5;
  static const int _maxAttempts = 8;

  final http.Client _client;

  Future<GameQuestion> fetchQuestion() async {
    int attempt = 0;

    while (attempt < _maxAttempts) {
      attempt++;
      try {
        final http.Response response = await _client.get(Uri.parse(_endpoint));
