...
class CityServiceEditViewController extends GetxController {
  static Map<MyServiceCategory, List<MyServiceItemId>> _createCategoryMap() {
    ...
    categoryMap.removeWhere((category, serviceList) => serviceList.isEmpty);
    return categoryMap;
  }

  final Map<MyServiceCategory, List<MyServiceItemId>> categoryMap = _createCategoryMap();
